...
const steps = [
  {
    n: '01',
    title: 'Imersão',
    desc: 'Entendemos a fundo o projeto, a marca, o mercado e os objetivos. Nada começa antes de realmente ouvir.',
  },
  {
    n: '02',
    title: 'Estratégia',
    desc: 'Definimos o posicionamento, a linguagem visual e o caminho criativo com clareza e intenção.',
  },
  {
    n: '03',
    title: 'Direção Criativa',
    desc: 'Desenvolvemos o conceito central, a identidade visual e a estética que vai guiar tudo.',
  },
  {
    n: '04',
    title: 'Desenvolvimento',
    desc: 'Executamos com precisão — código limpo, design refinado e atenção a cada detalhe.',
  },
  {
    n: '05',
    title: 'Entrega',
    desc: 'Lançamento, ajustes finais e suporte para o próximo capítulo da sua presença digital.',
  },
]
    ...
    <section id="processo" className="py-36 md:py-52">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.h2
          ...
          className="font-syne font-bold text-white/85 mb-20 leading-[1.1]"
          style={{ fontSize: 'clamp(1.9rem, 3.8vw, 3rem)' }}
        >
          Como trabalhamos<br />
          <span className="text-white/25 italic">juntos.</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-px relative">
          ...
          <motion.div
            ...
            className="absolute top-[22px] left-0 right-0 h-px bg-white/[0.07] origin-left hidden md:block"
          />
            ...
            >
              ...
              <div className="absolute top-0 left-0 flex items-center gap-3 md:flex-col md:items-start md:gap-0">
                <div className="relative w-[42px] h-[42px] flex items-center justify-center">
                  ...
                  <span className="font-mono text-[10px] tracking-[0.1em] text-white/35 relative z-10">{step.n}</span>
                </div>
              </div>
