    ...
    <section className="content-auto py-20 md:py-36 lg:py-52 overflow-hidden">
      <div className="max-w-wide mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          >
            <h2 className="font-syne font-bold text-display-section text-white/85">
          ...
          <motion.div
            ...
            className="relative rounded-lg border border-white/[0.1] overflow-hidden shadow-2xl bg-chrome-canvas"
          >
            {/* Chrome bar */}
            <div className="flex items-center gap-3 px-4 py-3 bg-chrome-bar">
              ...
              <div className="flex-1 min-w-0 flex items-center gap-2 rounded-sm px-3 py-1.5 bg-chrome-pill border border-white/[0.07]">
            ...
            <div className="relative chrome-dot-grid px-8 py-14 sm:px-12 sm:py-16 min-h-[260px] flex flex-col justify-center">
              <div className="relative inline-block w-fit">
                <div
                  className="absolute -inset-x-4 -inset-y-3 border border-dashed rounded-sm"
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-white/[0.06] bg-chrome-bar">
              <span className="font-mono text-xs flex items-center gap-2" style={{ color: '#6e6e73' }}>
                <span className="text-chrome-accent">❯</span> role pra ver mais
              </span>
              <span className="font-mono text-xs tabular-nums" style={{ color: '#47474a' }}>
                STUDIO
              </span>
            </div>
          </motion.div>
