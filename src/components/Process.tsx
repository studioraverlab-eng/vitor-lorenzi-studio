    ...
    <section id="processo" className="content-auto py-20 md:py-36 lg:py-52">
      <div className="max-w-wide mx-auto px-6">
        ...
        <motion.h2
          ...
          className="font-syne font-bold text-white/85 mb-16 leading-[1.1] text-display-section"
        >
          Como funciona<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-px relative">
          ...
          <motion.div
            ...
            className="absolute top-[21px] left-[21px] right-[calc(20%-21px)] h-px origin-left hidden md:block"
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <h3 className="font-syne font-semibold text-base text-white/72 mb-3 group-hover:text-white/88 transition-colors duration-300">
                {step.title}
              </h3>
              <p className="font-inter text-sm text-white/60 leading-[1.8] group-hover:text-white/75 transition-colors duration-300">
                {step.desc}
              </p>
